...
- Profiles 115 clear cell renal cell carcinoma tumors from patients treated with sunitinib and contrasts responders with non-responders.
- Identifies chromosome 7q gain and mTOR pathway activation as features associated with poor response to TKI therapy.
- Shows that proteomic and phosphoproteomic data highlight mTOR signaling as a central non-response program.
- Characterizes immune landscape differences across tumors and integrates them with response-associated molecular structure.
- Builds a multi-omics classifier with strong discrimination between responder and non-responder tumors.
...
- Article: <https://www.nature.com/articles/s41467-023-39981-6>
