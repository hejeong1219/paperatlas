...
- "활용 line"은 한미암 과제의 **구체적 단계**(1차 내성 분석 / 2차 내성 분석 /
  신생항원 파이프라인 / AI 예측 모형 / 데이터 전처리 / ppQTL 분석 / 인산화단백체 파이프라인 구축 등)에 매핑할 것
- 새로운 도구·개념을 그냥 던지지 말고, 본 과제의 어느 단계에 어떻게 연결되는지로 변환 — 단, 변환 결과를 명령형이 아닌 시사형으로
